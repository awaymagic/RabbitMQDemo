...
public class Subscriber {
    ...
    public Consumer<String> input() {
        return message -> System.out.println("received message from input binding ; message = " + message);
    }
    ...
    public Consumer<String> consu() {
        return message -> System.out.println("received message from echo2 binding ; message = " + message);
    }
